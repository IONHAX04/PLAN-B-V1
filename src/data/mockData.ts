...
export const aboutContent = {
  intro: "For us, every event is a unique moment that should inspire passion and be remembered for a long time. We don't just create experiences – we make sure they run smoothly.",
